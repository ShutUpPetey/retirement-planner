...
export function Layout({
  ...
  const iconBtn =
    'p-2 text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors';
  const menuItem =
    'w-full px-4 py-2 text-left text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 flex items-center gap-3';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-start justify-between gap-4">
            ...
            <div className="hidden md:flex items-center gap-3">
              ...
              {/* Export JSON backup */}
              <button onClick={onExportBackup} className={iconBtn} title="Export backup (JSON)">
              ...
              {/* Import backup */}
              <button onClick={handleImportClick} className={iconBtn} title="Import backup (JSON)">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {/* Export CSV */}
              <button onClick={onExportCsv} className={iconBtn} title="Export projections (CSV)">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 17v-2a2 2 0 012-2h2a2 2 0 012 2v2M9 7h6m-7 14h8a2 2 0 002-2V7l-5-4H7a2 2 0 00-2 2v14a2 2 0 002 2z" />
                </svg>
              </button>
            ...
            <div className="md:hidden relative">
              <button onClick={() => setIsMenuOpen(!isMenuOpen)} className={iconBtn} title="Menu">
