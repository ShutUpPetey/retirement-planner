...
export const LEAN_FIRE_MULTIPLIER = 0.7; // Lean FIRE = 70% of target spending
export const FAT_FIRE_MULTIPLIER = 1.6;  // Fat FIRE = 160% of target spending

// Default pre-retirement return used if no account return rates are available
export const DEFAULT_ACCUMULATION_RETURN = 0.07;
